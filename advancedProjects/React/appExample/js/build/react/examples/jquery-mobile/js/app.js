...
var App = React.createClass({
  ...
  render: function render() {
    return React.DOM.div({ className: 'app' }, JQueryMobilePage({ id: 'one' }, PageOneContent(null)), JQueryMobilePage({ id: 'two' }, PageTwoContent(null)), JQueryMobilePage({ id: 'popup', headerTheme: 'b' }, PagePopUpContent(null)));
  }
});
...
var JQueryMobileContent = React.createClass({
  ...
  render: function render() {
    return React.DOM.div({ role: 'main', className: 'ui-content' }, this.props.children);
  }
});
...
var JQueryMobileFooter = React.createClass({
  ...
  render: function render() {
    return React.DOM.div({ 'data-role': 'footer' }, React.DOM.h4(null, 'Page footer'));
  }
});
...
var JQueryMobileHeader = React.createClass({
  ...
  render: function render() {
    return React.DOM.div({ 'data-role': 'header', 'data-theme': this.props.headerTheme }, React.DOM.h1(null, this.props.title));
  }
});
...
var JQueryMobilePage = React.createClass({
  ...
  render: function render() {
    ...
    return React.DOM.div(props, JQueryMobileHeader({ title: 'Page ' + this.props.id, headerTheme: this.props.headerTheme }), JQueryMobileContent(null, this.props.children), JQueryMobileFooter(null));
  }
});
